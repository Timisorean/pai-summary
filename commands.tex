...
\NewDocumentCommand{\ceil}{m}{\lceil #1 \rceil}
\NewDocumentCommand{\ip}{m}{\langle #1 \rangle}

\newcommand*{\abs}[1]{| #1 |}
\newcommand*{\card}[1]{| #1 |}
\NewDocumentCommand{\norm}{sm}{\IfBooleanTF{#1}{\|#2\|}{\| #2 \|}}
...
\newcommand{\SoR}{\mathrm{SoR}}
\newcommand{\FITC}{\mathrm{FITC}}
\newcommand{\mse}{\mathrm{mse}}
...
\RenewDocumentCommand{\H}{mo}{\mathrm{H}\IfValueTF{#2}{\![#1\ |\ #2]}{\brackets{#1}}}
\NewDocumentCommand{\Hsm}{mo}{\mathrm{H}\IfValueTF{#2}{[#1 \mid #2]}{\brackets{#1}}}
\NewDocumentCommand{\I}{mmo}{\mathrm{I}\IfValueTF{#3}{\!(#1;#2\ |\ #3)}{\parentheses{#1; #2}}}
...
\NewDocumentCommand{\E}{somo}{\ensuremath{\mathbb{E}\IfValueT{#2}{_{#2}}{} \IfBooleanTF{#1}{#3}{\IfValueTF{#4}{\![#3\ |\ #4]}{\brackets{#3}}}}}
\NewDocumentCommand{\Var}{somo}{\mathrm{Var}\IfValueT{#2}{_{#2}}{} \IfBooleanTF{#1}{#3}{\IfValueTF{#4}{\![#3\ |\ #4]}{\brackets{#3}}}}
...
\NewDocumentCommand{\N}{somm}{\mathcal{N}\IfBooleanTF{#1}{(}{(}\IfValueT{#2}{#2;}{} #3, #4\IfBooleanTF{#1}{)}{)}}
