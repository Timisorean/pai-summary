...
&\log p_\lambda(x_0) \geq \log p_\lambda(x_0) - \spa{D}_{\mathrm{KL}}(q(\cdot \mid x_0) \| p_\lambda(\cdot \mid x_0)) \\[-1ex]
...
&= \E["]{\log p_\lambda(x_T) - \sum_{t=2}^T \log \frac{q(x_t \mid x_{t-1})}{p_\lambda(x_{t-1} \mid x_t)} - \log \frac{q(x_1 \mid x_0)}{p_\lambda(x_0 \mid x_1)}}\\[-1ex]
