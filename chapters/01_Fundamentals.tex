...
\begin{itemize}
    ...
    \item Under some conditions, the \textbf{Gaussian is self-conjugate} (Gaussian prior and likelihood $\rightarrow$ posterior Gaussian).
\end{itemize}
...
\begin{itemize}
    ...
    with known mean and variance: $\sfrac{1}{2} \cdot \log \parentheses{(2 \pi e)^d \det{\mSigma}}$
