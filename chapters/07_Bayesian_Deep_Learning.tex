...
\begin{itemize}
    ...
    \item Intuitively, variational inference in BNNs can be interpreted as averaging the predictions of multiple NNs drawn according to the variational posterior $q_\vlambda$.
...
\begin{itemize}
    \item \textbf{Dropout/Dropconnect} randomly omits vertices/\\
    edges of the comp. graph. For valid interpretation of this as variational inference, we also need to perform dropout/dropconnect during inference.
...
\begin{framed}
     Popular method: \textbf{evidence of a val. set}; How well is val. set described by trained model:\\
